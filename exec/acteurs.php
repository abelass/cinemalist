...
function exec_acteurs(){
	
	if ($GLOBALS['meta']['version_installee'] <= '1.927'){
		echo debut_page(_T('cinemalist:cinemalist'), "acteurs", "cinemalist");	
	}else{
		echo inc_commencer_page_dist(_T('cinemalist:cinemalist'), "acteurs", "cinemalist");
	}
	...
	echo debut_droite(_T('cinemalist:les_acteurs'));
	
	echo recuperer_fond('prive/acteurs/acteurs',$contexte,array('ajax'=>true));
