...
function exec_scenaristes(){
	
	if ($GLOBALS['meta']['version_installee'] <= '1.927'){
		echo debut_page(_T('cinemalist:cinemalist'), "scenaristes", "cinemalist");	
	}else{
		echo inc_commencer_page_dist(_T('cinemalist:cinemalist'), "scenaristes", "cinemalist");
	}
	...
	echo debut_droite(_T('cinemalist:les_scenaristes'));
	
	echo recuperer_fond('prive/scenaristes/scenaristes',$contexte,array('ajax'=>true));
